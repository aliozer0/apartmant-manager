...
class _ApartmantsGuestState extends State<ApartmantsGuest> {
  ...
  Future<void> _initializeData() async {
    String? apartmentUid = await PreferenceService.getApartmentUid();
    if (apartmentUid != null) {
      globalService.fetchApartments(apartmentUid);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: RefreshIndicator(
          ...
          onRefresh: () async {
            await globalService.fetchApartments(apartmentUid!);
          },
          child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                if (globalService.apartments$.value == null) {
                  ...
                  return Center(
                      child: Text('No Apartment Found'.tr(),
                          style: k19_5Gilroy(context)));
                }
                ...
                return SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) => apartmentGuestItem(
                          globalService.apartments$.value![index], context),
                    ));
              }),
        ));
  }
...
Widget apartmentGuestItem(Apartment apartment, BuildContext context) {
  ...
  return Container(
      ...
      child: InkWell(
          borderRadius: borderRadius10,
          onTap: () async {
            final fees = await GetIt.I<GlobalService>()
                .fetchFees(apartmentUid!, apartment.id!);
            Navigator.push(
                context,
                    ...
                    children: [
                      ...
                      IntrinsicHeight(
                        ...
                        if (apartment.plateNo != null)
                          VerticalDivider(
                              color: Colors.grey[400], thickness: 1, width: 20),
                        if (apartment.plateNo != null)
                          Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.start,
